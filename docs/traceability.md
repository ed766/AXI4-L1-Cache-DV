...
| Implementation-cost proxy is tied to the associativity study | Yosys synthesis of 128x1 and 64x2 variants | cell/memory-count extraction | synthesizable subset lint remains clean | `synthesis_characterization.csv` |
